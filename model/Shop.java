...
public class Shop {
     ...
     */
    public Shop() {
        available.add(new PlayerCard("Anthony Edwards", 1000,  "Okay Shooting Guard",               "SCORE_BOOST", 1));
        available.add(new PlayerCard("Donovan Mitchell", 2000,  "The Spida. The GOAT",  "FREE_HIT",    1));
        available.add(new PlayerCard("Nikola Jokic",    3500,  "3x MVP. Does everything.",                 "SCORE_BOOST", 2));
        available.add(new PlayerCard("Luka Doncic",     6000,  "THE DON",                     "MULTIPLIER",  1.5));
